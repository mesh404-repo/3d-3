...
class Settings(BaseSettings):
    ...
    trellis_slat_steps: int = Field(default=35, env="TRELLIS_SLAT_STEPS")
    trellis_slat_cfg_strength: float = Field(default=2.5, env="TRELLIS_SLAT_CFG_STRENGTH")
    ...
    background_removal_model_id: str = Field(default="miner-bit/bg_rm2", env="BACKGROUND_REMOVAL_MODEL_ID")
